#参考来源：https://blog.csdn.net/qq_40107474/article/details/88737474?depth_1-u
#tm_source=distribute.pc_relevant.none-task&utm_source=distribute.pc_relevant.none-task
import turtle, time
def drawGap(): #绘制数码管间隔
    turtle.penup()
    turtle.fd(5)
...
def text():
    ...
    turtle.write('大惜和小刘在一起：',font=("Arial", 18, "normal"))
    turtle.penup()
    turtle.goto(-350,100)
    turtle.pendown()
    turtle.pensize(5)
